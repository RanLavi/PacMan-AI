...
class ExactInference(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        if noisyDistance == None: # Then a ghost is eaten
            allPossible[self.getJailPosition()] = 1.0
        else: # Otherwise, update distance
    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for oldPos in self.legalPositions:
            newPosDis = self.getPositionDistribution(self.setGhostPosition(gameState, oldPos))
            for newPos, prob in newPosDis.items():
    ...
    def observe(self, observation, gameState):
        ...
        if noisyDistance is None:
            ...
            for pos in self.legalPositions:
                ...
                allPossible[pos] = emissionModel[dis] * currBeliefs[pos]
...
class JointParticleFilter:
    ...
    def elapseTime(self, gameState):
        ...
        for oldParticle in self.particles:
            ...
            "*** YOUR CODE HERE ***"
            for i in range(self.numGhosts):
                probDist = getPositionDistributionForGhost(setGhostPositions(gameState, newParticle), i,
                                                           self.ghostAgents[i])
